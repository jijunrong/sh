...
#一键DD脚本
function Debian(){
wget -O "/root/debian.sh" "https://raw.githubusercontent.com/jijunrong/sh/main/debian.sh" --no-check-certificate -T 30 -t 5 -d
chmod +x "/root/debian.sh"
chmod 777 "/root/debian.sh"
blue "下载完成"
